    ...
    apps: [
        {
            name: "api-hono",
            cwd: "./apps/api-hono",
            script: "node ./node_modules/.bin/dotenvx run -f .env.production -- node ./dist/index.js",
        ...
        },
        {
            name: "web-astro",
            cwd: "./apps/web-astro",
            script: "node ./node_modules/.bin/dotenvx run -f .env.production -- node ./dist/server/entry.mjs",
            // https://www.digitalocean.com/community/tutorials/how-to-scale-node-js-applications-with-clustering#step-5-using-pm2-for-clustering
            instances: 0,
            exec_mode: "cluster",
