...
export const removeStoreTeamMember_SchemaValidator = zValidator(
    'json',
    z.object({
...
export const removeStoreTeamMember_Handler = async (c: Context<
    HonoVariables,
    "/:storeId/team_remove_member",
    ValidatorContext<typeof removeStoreTeamMember_SchemaValidator>
>) => {
