...
export const updateRestaurantTeamMemberPermissions_SchemaValidator = zValidator(
    'json',
    z.object({
...
export const updateRestaurantTeamMemberPermissions_Handler = async (c: Context<
    HonoVariables,
    "/:restaurantId/team_update_permissions",
    ValidatorContext<typeof updateRestaurantTeamMemberPermissions_SchemaValidator>
>) => {
