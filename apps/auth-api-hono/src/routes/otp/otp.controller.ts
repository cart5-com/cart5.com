...
import { upsertUserService, markEmailAsVerifiedService } from '../user/user.service';
...
export const sendOtpRoute = async (c: Context<HonoVariables, "/otp/send", ValidatorContext<typeof sendOtpSchemaValidator>>) => {
...
export const verifyOtpRoute = async (c: Context<HonoVariables, "/otp/verify", ValidatorContext<typeof verifyOtpSchemaValidator>>) => {
