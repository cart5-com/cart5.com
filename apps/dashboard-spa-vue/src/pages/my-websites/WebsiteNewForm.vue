...
async function onSubmit(values: z.infer<typeof schema>) {
    ...
    await withSubmit(async () => {
        ...
        if (error) {
            ...
            // Success
            myWebsites.value = [...myWebsites.value, { id: data, name: values.name, defaultHostname: values.defaultHostname, domains: [] }];
    ...
    <AutoForm class="space-y-6"
              ...
              :field-config="{
                ...
                defaultHostname: {
                    ...
                    description: 'Enter a default hostname for your website (e.g., mysite)',
                }
            }">
